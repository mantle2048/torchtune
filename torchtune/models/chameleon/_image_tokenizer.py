...
from torchtune.models.chameleon._vqgan import VQModel
...
class ChameleonImageTokenizer:
    ...
    def _vqgan_input_from(
        self, img: Image.Image, target_image_size=512
    ) -> torch.Tensor:
    ...
    def img_tokens_from_pil(self, image: Image.Image):
    ...
    def pil_from_img_toks(self, img_tensor: torch.Tensor) -> Image.Image:
